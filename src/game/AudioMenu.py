...
class AudioScene:
    ...
    def init_ui_elements(self):
        # Initialize back button and sliders with placeholder positions
        ...
        # Update elements to their correct positions
    ...
    def update_elements(self, width: int, height: int):
        ...
        # Update and re-initialize Slider positions
        self.slider_one.__init__((screen_center_x, slider_one_y), (200, 20), 0, 100, self.slider_one.current_val, Gamestate)
        self.slider_two.__init__((screen_center_x, slider_two_y), (200, 20), 0, 100, self.slider_two.current_val, Gamestate)
